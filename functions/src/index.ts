...
export const onResultSubmitted = functions.firestore.document('matches/{matchId}/results/{userId}').onCreate(async (_, context) => {
    ...
    return db.runTransaction(async (t) => {
        ...
        if (['completed', 'cancelled', 'disputed'].includes(matchData.status)) return;
...
export const onMatchCompleted = functions.firestore.document("matches/{matchId}").onUpdate(async (change, context) => {
