                        ...
                        <CardContent className="space-y-4">
                            <div className="flex justify-between items-center p-3 bg-muted rounded-md">
                             ...
                             <div className="flex justify-between items-center p-3 bg-muted rounded-md">
                                ...
                                <p className="font-bold text-lg">{userData && userData.matchesPlayed && userData.matchesPlayed > 0 ? `${((userData.matchesWon || 0) / userData.matchesPlayed * 100).toFixed(0)}%` : 'N/A'}</p>
                            </div>
                        </CardContent>
                    </Card>
                </div>
