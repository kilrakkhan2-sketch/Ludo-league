...
export default function SplashPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans items-center justify-center bg-background">
        ...
        <h1 className="text-5xl font-bold font-headline mt-6 bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">
            LudoLeague
        </h1>
